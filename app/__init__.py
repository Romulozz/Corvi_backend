...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('mysql://root:wveAFaCpNabpgjwAaWLgbLBelKuYKoHq@mysql.railway.internal:3306/railway')  # Railway genera automáticamente DATABASE_URL
